...
:}.}
<div id="serverinfo">
	<a href="https://time.is/Singapore" title="Build-time: %build-time%"><i class="fa fa-coffee"></i> {.!Uptime.}: %uptime%</a>
	<p>server maintainace and backup will be conducted on saturday evenings <time datetime="23:00">23:00</time> files might be offline.</p>
	<html>
